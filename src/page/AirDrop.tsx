...
function AirdropContent({ balance, onEarn, onWithdraw }: { balance: number; onEarn: () => void; onWithdraw: () => void }) {
  return (
    <>
...
function EarnContent({ onBack }: { onBack: () => void }) {
  return (
...
function MineContent({ onBack }: { onBack: () => void }) {
  return (
    <section className="page-card">
...
function FriendsContent({ onBack }: { onBack: () => void }) {
  return (
    <section className="page-card">
      <div className="page-icon">👥</div>
      <h3>Friends</h3>
...
function ExchangeContent({ onBack }: { onBack: () => void }) {
  return (
    <section className="page-card">
      <div className="page-icon">🔄</div>
      <h3>Exchange</h3>
